...
import { FetchList } from './reducers/ListImage';

function ImageManagement(props) {

    const dispatch = useDispatch();

    const ListImage = useSelector(state => state.ListImage);
